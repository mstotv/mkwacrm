...
```bash
# 1. Fork on GitHub: https://github.com/ArnasDon/mk whats → Fork
# 2. Clone your fork
git clone https://github.com/<your-username>/mk whats.git
cd mk whats
...
```bash
git remote add upstream https://github.com/ArnasDon/mk whats.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/ArnasDon/mk whats/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `mkwhats.tech` URL belong to the upstream project; please swap them
