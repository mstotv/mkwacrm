# mk whats — MitaKurd for WhatsApp Auto
...
[![CI](https://github.com/ArnasDon/mk whats/actions/workflows/ci.yml/badge.svg)](https://github.com/ArnasDon/mk whats/actions/workflows/ci.yml)
[![Next.js 16](https://img.shields.io/badge/Next.js-16-black?logo=nextdotjs)](https://nextjs.org)
[![Supabase](https://img.shields.io/badge/Supabase-Postgres%20%2B%20Auth-3ecf8e?logo=supabase)](https://supabase.com)
[![Stars](https://img.shields.io/github/stars/ArnasDon/mk whats?style=social)](https://github.com/ArnasDon/mk whats/stargazers)

The marketing site and self-host docs live in a separate repo:
[ArnasDon/mk whats-site](https://github.com/ArnasDon/mk whats-site)
([mkwhats.tech](https://mkwhats.tech)). This repo is the product —
...
```bash
# Fork on GitHub first: https://github.com/ArnasDon/mk whats → Fork
...
<p align="center">
  <a href="https://mkwhats.tech/docs/deployment-hostinger">
    <img src="https://img.shields.io/badge/Step--by--step_guide-mkwhats.tech%2Fdocs-111?style=for-the-badge" alt="Step-by-step guide" height="44">
  </a>
</p>

**mk whats is built to run on [Hostinger](https://www.hostinger.com/web-apps-hosting).**
...
**[mkwhats.tech/docs/deployment-hostinger](https://mkwhats.tech/docs/deployment-hostinger)**.

> _Note: mk whats is MIT-licensed and runs anywhere Node.js does
...
**[mkwhats.tech/docs](https://mkwhats.tech/docs)**
(source: [ArnasDon/mk whats-site](https://github.com/ArnasDon/mk whats-site)).

Key pages:
- [Getting started](https://mkwhats.tech/docs/getting-started)
- [Supabase setup](https://mkwhats.tech/docs/supabase-setup)
- [WhatsApp setup](https://mkwhats.tech/docs/whatsapp-setup)
- [Environment variables](https://mkwhats.tech/docs/environment-variables)
- [Deploy on Hostinger](https://mkwhats.tech/docs/deployment-hostinger)
- [Architecture](https://mkwhats.tech/docs/architecture)
- [Troubleshooting](https://mkwhats.tech/docs/troubleshooting)
